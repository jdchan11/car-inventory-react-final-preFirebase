...
const useStyles = makeStyles((theme: Theme) => createStyles({
    main: {
        ...
        backgroundImage: `linear-gradient(180deg, rgba(2,0,36,1) 0%, rgba(85,9,121,1) 76%, rgba(15,174,207,1) 100%)`,
        width: '100%',
        height: '100%',
        position: 'absolute',
        ...
        <div className={`${classes.root} ${classes.column}`}>
            ...
            <AppBar position="fixed" className={clsx(classes.appBar, {[classes.appBarShift]: open })}>
                <Toolbar className={classes.toolbar}>
                    ...
                    <Button className={classes.toolbar_button} onClick={handleDialogClickOpen}>Add Car to Inventory</Button>
